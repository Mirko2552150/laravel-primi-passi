...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <title>Document Prima lezione LARAVEL</title>
  </head>
  <body>
    <div class="cards">
      @foreach ($cards as $key => $card)
        <div class="card">
          ...
          <div class="card-link">
            <h3><a href="#">{{$card['titolo']}}</a></h3>
            <a href="#"><svg class="mk-svg-icon" data-name="mk-li-food" data-cacheid="icon-5eabe39c707e5" style=" height:32px; width: 32px; " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
